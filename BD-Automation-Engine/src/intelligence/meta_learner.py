...
_CONTACT_EVENTS: List[Dict[str, Any]] = [
    ...
    },
    {
        "contact": "c004",
        "event": "multi_program",
        "programs": ["DCGS-A", "DCGS-N", "GBSD"],
        "role": "BD Lead",
    },
    {
        "contact": "c005",
        "event": "multi_program",
        "programs": ["DCGS-A", "GBSD"],
        "role": "VP Engineering",
    },
    {
        "contact": "c006",
...
_COMPETITOR_ACTIVITY: List[Dict[str, Any]] = [
    {
        ...
        "postings": 8,
        "month": "2025-03",
        "roles": ["Systems Engineer", "Analyst"],
    },
    {
        "competitor": "Northrop",
        "program": "GBSD",
...
class MetaLearningEngine:
    ...
    def learn_outreach(self) -> List[OutreachInsight]:
        ...
        for entry in _OUTREACH_LOG:
            ch = entry["channel"]
            tier = entry["tier"]
            channel_tier.setdefault(ch, {}).setdefault(tier, []).append(
                entry["responded"]
            )
        ...
        for channel, tiers in channel_tier.items():
            ...
            insights.append(
                OutreachInsight(
                    ...
                    if avg_rate < 0.6
                    else InsightSeverity.LOW.value,
        ...
        insights.append(
            OutreachInsight(
                ...
                recommendations=[
                    f"Schedule high-priority outreach on {day} around {hour}:00"
                ],
            ...
            if n_programs >= 2:
                insights.append(
                    ContactInsight(
                        ...
                        recommendations=[
                            f"Prioritize relationship with {entry['contact']}"
                        ],
        ...
        if departures:
            ...
            insights.append(
                ContactInsight(
                    ...
                    recommendations=[
                        "Engage during transition period (4-6 month fill window)"
                    ],
    ...
    def learn_data_quality(self) -> List[MetaInsight]:
        ...
        insights.append(
            MetaInsight(
                ...
                confidence=0.78,
                recommendations=[
                    f"Prioritize '{best_source[0]}' for critical enrichment"
                ],
    ...
    def transfer_learning(
        self, source_program: str, target_program: str
    ) -> TransferReport:
        ...
        source_insights = [
            ...
            if (
                isinstance(i, ProgramInsight)
                and i.program_name.lower() == source_program.lower()
            )
    ...
    def get_outreach_effectiveness(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_rate": round(
                sum(1 for e in _OUTREACH_LOG if e["responded"])
                / max(len(_OUTREACH_LOG), 1),
                2,
            ),
        }
