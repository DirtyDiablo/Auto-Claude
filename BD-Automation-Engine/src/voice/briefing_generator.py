...
_PAIN_POINTS: Dict[str, List[Dict[str, Any]]] = {
    "c001": [
        {
            "description": "Struggling to fill senior cloud architect positions",
            "source": "humint",
            "severity": "high",
        },
        {
            "description": "Current SIGINT processing pipeline has latency issues",
            "source": "transcript",
            "severity": "critical",
        },
    ],
    "c002": [
        {
            "description": "Need cleared cybersecurity talent in Utah",
            "source": "humint",
            "severity": "high",
        },
    ],
    "c003": [
        {
            "description": "Navy DCGS modernization behind schedule",
            "source": "report",
            "severity": "critical",
        },
        {
            "description": "Integration challenges with legacy GCCS-J",
            "source": "transcript",
            "severity": "high",
        },
    ],
    ...
    "c001": [
        {
            ...
            "date": "2025-12-15",
            "outcome": "positive",
            "follow_up": "Send staffing proposal by Jan 5",
            "notes": "Discussed cloud migration timeline",
        },
        {
            "type": "email",
            "date": "2025-12-20",
    ...
    "c003": [
        {
            ...
            "date": "2025-11-10",
            "outcome": "positive",
            "follow_up": "Schedule follow-up demo in Q1 2026",
            "notes": "Demo'd data fusion capabilities",
        },
    ],
}
...
_PAST_PERFORMANCE: Dict[str, List[Dict[str, Any]]] = {
    "DCGS-A": [
        {
            "project": "DCGS Cloud Migration Phase 1",
            "role": "Prime",
            "value_m": 12.5,
            "period": "2023-2024",
            "rating": "Exceptional",
        ...
        {
            "project": "ISR Data Fusion Prototype",
            "role": "Sub",
            "value_m": 3.2,
            "period": "2024",
            "rating": "Very Good",
    ...
    "GBSD": [
        {
            "project": "ICBM Test Infrastructure Support",
            "role": "Sub",
            "value_m": 5.8,
            "period": "2023-2025",
            "rating": "Satisfactory",
    ...
    "DCGS-N": [
        {
            "project": "Navy Maritime ISR Analysis",
            "role": "Sub",
            "value_m": 8.1,
            "period": "2024-2025",
            "rating": "Very Good",
...
_RECENT_NEWS: Dict[str, List[Dict[str, Any]]] = {
    "DCGS-A": [
        {
            "headline": "Leidos wins $200M DCGS-A sustainment extension",
            "date": "2026-01-15",
            "source": "Defense News",
        },
        {
            "headline": "AF DCGS migrating to AWS GovCloud in FY26",
            "date": "2025-12-20",
            "source": "C4ISRNET",
        },
    ],
    "DCGS-N": [
        {
            "headline": "Navy DCGS-N re-compete RFI expected Q2 2026",
            "date": "2026-01-10",
            "source": "FedBizOpps",
        },
    ],
...
_RELATIONSHIPS: Dict[str, List[Dict[str, Any]]] = {
    "c001": [
        {
            "contact_name": "Amanda Chen",
            "relationship": "colleague",
            "program": "DCGS-A",
            "contacted": True,
        },
        {
            "contact_name": "Bob Franklin",
...
class CallBriefingGenerator:
    ...
    def generate_briefing(self, contact_id: str) -> CallBriefing:
        ...
        # Relationships
        relationships = [
            RelationshipLink(**rel) for rel in _RELATIONSHIPS.get(contact_id, [])
        ]

        # Generate talking points
        talking_points = self._generate_talking_points(
            contact, pain_points, interactions, open_jobs
        )
    ...
    def _build_summary(
        ...
        if interactions:
            parts.append(
                f"Last contact: {interactions[0].date} ({interactions[0].outcome})."
            )
        if open_jobs:
