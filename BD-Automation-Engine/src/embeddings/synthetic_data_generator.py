...
_PROGRAMS = [
    ...
    },
    {
        "id": "prog_002",
        "name": "DCGS-N",
        "full_name": "Distributed Common Ground System - Navy",
        "prime": "Raytheon",
        "domain": "ISR",
        "value_m": 280,
    ...
    },
    {
        "id": "prog_003",
        "name": "GBSD",
        "full_name": "Ground Based Strategic Deterrent",
    ...
    },
    {
        "id": "prog_004",
        "name": "JADC2",
        "full_name": "Joint All-Domain Command and Control",
        "prime": "Multiple",
        "domain": "C2",
        "value_m": 1200,
    ...
    },
    {
        "id": "prog_005",
        "name": "ABMS",
        "full_name": "Advanced Battle Management System",
        "prime": "Multiple",
        "domain": "C2",
        "value_m": 3500,
    ...
    },
    {
        "id": "prog_007",
        "name": "NGJ-MB",
        "full_name": "Next Generation Jammer Mid-Band",
        "prime": "Raytheon",
        "domain": "EW",
        "value_m": 7600,
    ...
    },
    {
        "id": "prog_008",
        "name": "IVAS",
        "full_name": "Integrated Visual Augmentation System",
        "prime": "Microsoft",
...
_MASTER_NOTES = [
    {
        "id": "note_001",
        "contact_id": "c001",
        "content": "Craig mentioned they're struggling to fill 5 senior cloud architect positions at Langley. The SIGINT processing pipeline has latency issues. Budget for FY26 approved with $20M ceiling increase.",
        "date": "2026-01-15",
    },
    {
        "id": "note_002",
        "contact_id": "c003",
        "content": "James discussed the DCGS-N PED modernization effort. Legacy Java monolith needs decomposition into microservices. Raytheon lost 3 key engineers to AWS. Looking for Kubernetes and Kafka expertise.",
        "date": "2026-01-20",
    },
    {
        "id": "note_003",
        "contact_id": "c002",
        "content": "Sarah's team at Hill AFB needs 12 cleared developers for GBSD weapon system software. TS/SCI required. Northrop struggling with retention — offered 15% raises but still losing people to commercial tech.",
        "date": "2026-02-01",
    },
    {
        "id": "note_004",
        "contact_id": "c004",
        "content": "Amanda briefed on JADC2 architecture review. DOD moving to zero-trust with CMMC 2.0 compliance deadline Q3 FY26. Data mesh approach preferred over centralized data lake.",
        "date": "2026-02-05",
    },
    {
        "id": "note_005",
        "contact_id": "c005",
        "content": "Robert confirmed the DCGS-A recompete timeline: RFP expected September 2026, proposals due December. Option Year 3 exercise in June. Incumbent advantage strong but not guaranteed.",
        "date": "2026-01-28",
    },
    {
        "id": "note_006",
        "contact_id": "c001",
        "content": "Follow-up with Craig: BAE submitted unsolicited proposal for DCGS-A cloud migration but was rejected. Leidos prefers GDIT's GovCloud approach. Need to schedule demo of our Kubernetes platform.",
        "date": "2026-02-03",
    },
    {
        "id": "note_007",
        "contact_id": "c006",
        "content": "Diana needs 8 autonomy engineers for MQ-25 Stingray flight software. Boeing's St. Louis facility. Must have UAS experience and active TS/SCI. Timeline: fill by Q2 FY26.",
        "date": "2026-01-22",
    },
    {
        "id": "note_008",
        "contact_id": "c003",
        "content": "DCGS-N performance review: PED throughput improved 30% after initial microservices migration. James wants to accelerate Phase 2 covering ELINT and MASINT fusion. Budget request submitted for additional $15M.",
        "date": "2026-02-08",
    },
]
...
_JOBS = [
    {
        ...
        "location": "Langley AFB, VA",
        "clearance": "TS/SCI w/ CI Poly",
        "skills": ["AWS GovCloud", "Kubernetes", "Terraform", "Python"],
    ...
    },
    {
        ...
        "location": "Hill AFB, UT",
        "clearance": "TS/SCI",
        "skills": ["C++", "Ada", "Real-time systems", "DO-178C"],
    ...
    },
    {
        ...
        "location": "St. Inigoes, MD",
        "clearance": "TS/SCI w/ CI Poly",
        "skills": ["Kubernetes", "Kafka", "Java", "Microservices"],
    ...
    },
    {
        ...
        "location": "Pentagon, VA",
        "clearance": "TS/SCI",
        "skills": ["Zero Trust", "CMMC", "Network Security", "SASE"],
...
class SyntheticDataGenerator:
    ...
    def generate(
        ...
        for t in generated:
            source_counts[t.source_collection] = (
                source_counts.get(t.source_collection, 0) + 1
            )
    ...
    def _generate_pain_point(self, max_count: int) -> List[Triplet]:
        ...
        for query_text, positive_kw, negative_kw in pain_queries[:max_count]:
            ...
            pos_notes = [
                n for n in _MASTER_NOTES if positive_kw in n["content"].lower()
            ]
            neg_notes = [
                n
                for n in _MASTER_NOTES
                if negative_kw in n["content"].lower()
                and positive_kw not in n["content"].lower()
            ]
            ...
            if pos_notes:
                ...
                neg_note = (
                    ...
                    if neg_notes
                        ...
                        [n for n in _MASTER_NOTES if n["id"] != pos_note["id"]]
                    )
                )
                ...
                triplets.append(
                    Triplet(
                        query=query,
                        positive=pos_note["content"],
                        negative=neg_note["content"],
    ...
    def _generate_temporal(self, max_count: int) -> List[Triplet]:
        ...
        temporal_facts = [
            {
                "query": "When is the DCGS-A recompete?",
                "positive": "The DCGS-A recompete RFP is expected September 2026, with proposals due December 2026. Option Year 3 exercise is due June 2026.",
                "negative": "The GBSD Critical Design Review is scheduled for early 2027.",
            },
            {
                "query": "What contract milestones are coming up in FY26?",
                "positive": "DCGS-A Option Year 3 exercise due June 2026. DCGS-A recompete RFP expected September 2026. CMMC 2.0 compliance deadline Q3 FY26.",
                "negative": "The MQ-25 Stingray initial operational capability is projected for FY28.",
            },
            {
                "query": "What budget changes happened recently?",
                "positive": "DCGS-A FY26 budget approved with $20M ceiling increase. DCGS-N submitted request for additional $15M for Phase 2 PED modernization.",
                "negative": "GBSD program continues at steady-state funding levels.",
            },
            {
                "query": "What hiring timelines exist?",
                "positive": "Boeing MQ-25 needs 8 autonomy engineers filled by Q2 FY26. Langley DCGS-A has 5 open cloud architect positions. GBSD needs 12 cleared developers.",
                "negative": "JADC2 architecture review is an ongoing advisory role with no fixed hiring deadline.",
            },
        ]
    ...
    def generate_from_notes(self, max_count: int = 20) -> List[Triplet]:
        ...
        for note in _MASTER_NOTES[:max_count]:
            contact = next(
                (c for c in _CONTACTS if c["id"] == note["contact_id"]), None
            )
            if not contact:
                continue
            query = (
                f"What was discussed with {contact['name']} about {contact['program']}?"
            )
    ...
    def _find_hard_negative(self, triplet: Triplet) -> Optional[str]:
        ...
        if triplet.source_collection == "programs":
            ...
            for prog in _PROGRAMS:
                ...
                if (
                    prog["name"].lower() not in pos_lower
                    and prog["domain"].lower() in pos_lower
                ):
                    return prog_text
    ...
    def get_triplets(
        self, strategy: str = "", source: str = "", difficulty: str = ""
    ) -> List[Triplet]:
