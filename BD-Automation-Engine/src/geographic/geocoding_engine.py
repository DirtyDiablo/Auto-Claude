...
class GeoPoint:
    ...
    address: str = ""
    facility_type: str = (
        ""  # base | scif | hq | lab | shipyard | arsenal | depot | center
    )
    state: str = ""
...
_FACILITIES: List[Dict[str, Any]] = [
    # === NCR (National Capital Region) ===
    {
        ...
        "region": "NCR",
        "type": "hq",
        "aliases": ["Pentagon, VA", "The Pentagon"],
    },
    {
        "name": "Fort Belvoir",
        "lat": 38.7118,
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["Ft Belvoir", "Fort Belvoir, VA"],
    },
    {
        "name": "Fort Meade",
        "lat": 39.1086,
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["Ft Meade", "Fort Meade, MD", "NSA HQ"],
    },
    {
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["JB Andrews", "Andrews AFB"],
    },
    {
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["JBAB", "Bolling AFB", "Anacostia"],
    },
    {
        "name": "NGA Campus East",
        "lat": 38.7505,
        "lng": -77.1744,
        "state": "VA",
        "region": "NCR",
        "type": "center",
        "aliases": ["NGA East", "Springfield NGA"],
    },
    {
        "name": "NGA New Campus",
        "lat": 38.6335,
        ...
        "region": "midwest",
        "type": "center",
        "aliases": ["NGA St Louis", "NGA West", "Next NGA West"],
    },
    {
        "name": "Reston",
        "lat": 38.9586,
        ...
        "region": "NCR",
        "type": "hq",
        "aliases": ["Reston, VA", "Reston Town Center"],
    },
    {
        "name": "Tysons Corner",
        "lat": 38.9187,
        ...
        "region": "NCR",
        "type": "hq",
        "aliases": ["Tysons, VA", "McLean, VA", "Tysons Corner, VA"],
    },
    {
        "name": "Chantilly",
        "lat": 38.8943,
    ...
    },
    {
        ...
        "region": "NCR",
        "type": "hq",
        "aliases": ["GDIT Falls Church", "Falls Church, VA"],
    },
    {
        "name": "Leidos HQ",
        "lat": 38.9570,
        ...
        "region": "NCR",
        "type": "hq",
        "aliases": ["Leidos Reston", "1750 Presidents St"],
    },
    # === Virginia (non-NCR) ===
    {
        "name": "Langley AFB",
    ...
    },
    {
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["NS Norfolk", "Norfolk Naval Station", "Norfolk, VA"],
    },
    {
        "name": "Dam Neck",
        "lat": 36.8113,
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["Dam Neck Annex", "NSWC Dam Neck", "Virginia Beach, VA"],
    },
    {
        "name": "Quantico",
        "lat": 38.5227,
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["MCB Quantico", "Quantico, VA", "FBI Academy"],
    },
    {
        "name": "Dahlgren",
        "lat": 38.3495,
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["NSWC Dahlgren", "Dahlgren, VA"],
    },
    {
        ...
        "region": "southeast",
        "type": "center",
        "aliases": ["Charlottesville, VA", "NGIC"],
    },
    # === Maryland ===
    {
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["APG", "Aberdeen, MD", "Aberdeen Proving Ground, MD"],
    },
    {
        "name": "Patuxent River",
        "lat": 38.2851,
    ...
    },
    {
        ...
        "region": "NCR",
        "type": "base",
        "aliases": ["NSWC Indian Head", "Indian Head, MD"],
    },
    {
        ...
        "region": "NCR",
        "type": "center",
        "aliases": ["Annapolis Junction, MD", "FANX"],
    },
    {
        "name": "Columbia",
        "lat": 39.2037,
    ...
    },
    {
        ...
        "region": "west",
        "type": "base",
        "aliases": ["Vandenberg, CA", "Vandenberg AFB"],
    },
    {
        "name": "San Diego",
        "lat": 32.7157,
        ...
        "region": "west",
        "type": "base",
        "aliases": ["San Diego, CA", "SPAWAR", "NAVWAR"],
    },
    {
        "name": "Point Mugu",
        "lat": 34.1193,
        ...
        "region": "west",
        "type": "base",
        "aliases": ["NAWC Point Mugu", "Point Mugu, CA"],
    },
    {
        "name": "China Lake",
        "lat": 35.6864,
        ...
        "region": "west",
        "type": "base",
        "aliases": ["NAWC China Lake", "China Lake, CA", "Ridgecrest, CA"],
    },
    {
        "name": "El Segundo",
        "lat": 33.9192,
        ...
        "region": "west",
        "type": "center",
        "aliases": ["El Segundo, CA", "Los Angeles AFB", "Space Systems Command"],
    },
    # === Texas ===
    {
        "name": "Fort Cavazos",
        ...
        "region": "southwest",
        "type": "base",
        "aliases": ["Fort Hood", "Ft Cavazos", "Killeen, TX"],
    },
    {
        "name": "San Antonio",
        "lat": 29.4241,
    ...
    # === Ohio ===
    {
        ...
        "region": "midwest",
        "type": "base",
        "aliases": ["Wright-Patt", "WPAFB", "Dayton, OH", "AFRL"],
    },
    # === Colorado ===
    {
        "name": "Peterson SFB",
        ...
        "region": "west",
        "type": "base",
        "aliases": ["Peterson AFB", "Colorado Springs, CO", "NORAD"],
    },
    {
        "name": "Schriever SFB",
        "lat": 38.8055,
        ...
        "region": "west",
        "type": "base",
        "aliases": ["Schriever AFB", "Space Delta"],
    },
    {
        "name": "Buckley SFB",
        "lat": 39.7174,
        ...
        "region": "west",
        "type": "base",
        "aliases": ["Buckley AFB", "Aurora, CO", "DGS-3"],
    },
    # === Alabama / Georgia ===
    {
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["Redstone", "Huntsville, AL", "MDA"],
    },
    {
    ...
    },
    {
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["Robins, GA", "Warner Robins, GA"],
    },
    # === Florida ===
    {
        "name": "Eglin AFB",
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["Eglin, FL", "Valparaiso, FL"],
    },
    {
        "name": "Hurlburt Field",
        "lat": 30.4273,
    ...
    },
    {
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["Patrick AFB", "Cape Canaveral, FL"],
    },
    {
        "name": "MacDill AFB",
        "lat": 27.8491,
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["MacDill, FL", "Tampa, FL", "CENTCOM", "SOCOM"],
    },
    # === Other ===
    {
        "name": "Fort Liberty",
        ...
        "region": "southeast",
        "type": "base",
        "aliases": ["Fort Bragg", "Ft Liberty", "Fayetteville, NC", "JSOC"],
    },
    {
        "name": "Hill AFB",
        "lat": 41.1197,
        ...
        "region": "west",
        "type": "base",
        "aliases": ["Hill, UT", "Ogden, UT", "Hill AFB, UT"],
    },
    {
        "name": "Offutt AFB",
        "lat": 41.1186,
        ...
        "region": "midwest",
        "type": "base",
        "aliases": ["Offutt, NE", "Bellevue, NE", "STRATCOM"],
    },
    {
        ...
        "region": "west",
        "type": "base",
        "aliases": ["Pearl Harbor", "JBPHH", "Hickam AFB", "INDOPACOM"],
    },
    {
        "name": "Hanscom AFB",
        "lat": 42.4596,
    ...
    },
    {
        ...
        "region": "northeast",
        "type": "lab",
        "aliases": ["Rome, NY", "AFRL Rome", "Griffiss"],
    },
    # === Major Defense Contractor HQs ===
    {
        "name": "Northrop Grumman HQ",
        "lat": 38.9308,
        "lng": -77.2333,
        "state": "VA",
        "region": "NCR",
        "type": "hq",
        "aliases": ["Northrop Falls Church"],
    },
    {
        "name": "Raytheon HQ",
        "lat": 38.8700,
    ...
    },
    {
        ...
        "region": "NCR",
        "type": "hq",
        "aliases": ["ManTech Fairfax"],
    },
    {
        "name": "L3Harris Melbourne",
        "lat": 28.0836,
        "lng": -80.6081,
        "state": "FL",
        "region": "southeast",
        "type": "hq",
        "aliases": ["L3Harris HQ", "Melbourne, FL"],
    },
    {
        "name": "Boeing St. Louis",
        "lat": 38.7482,
        "lng": -90.3596,
        "state": "MO",
        "region": "midwest",
        "type": "hq",
        "aliases": ["Boeing Defense", "St. Louis, MO"],
    },
    {
        "name": "Lockheed Martin Bethesda",
        "lat": 38.9906,
        "lng": -77.0958,
        "state": "MD",
        "region": "NCR",
        "type": "hq",
        "aliases": ["Lockheed HQ", "Bethesda, MD"],
    },
]
...
_PROGRAM_LOCATIONS = [
    {
        "id": "prog_001",
        "name": "DCGS-A",
        "locations": ["Langley AFB, VA", "Fort Meade, MD", "Aberdeen, MD"],
    },
    {
        "id": "prog_002",
        "name": "DCGS-N",
        "locations": ["St. Inigoes, MD", "San Diego, CA", "Norfolk, VA"],
    },
    {"id": "prog_003", "name": "GBSD", "locations": ["Hill AFB, UT", "Vandenberg, CA"]},
    {
        "id": "prog_004",
        "name": "JADC2",
        "locations": ["Pentagon, VA", "Fort Meade, MD", "Colorado Springs, CO"],
    },
    {
        "id": "prog_005",
        "name": "MQ-25",
        "locations": ["St. Louis, MO", "Pax River, MD"],
    },
    {
        "id": "prog_006",
        "name": "ABMS",
        "locations": ["Hanscom, MA", "Wright-Patt", "Robins, GA"],
    },
    {
        "id": "prog_007",
        "name": "NGJ-MB",
        "locations": ["Point Mugu, CA", "China Lake, CA", "Pax River, MD"],
    },
    {
        "id": "prog_008",
        "name": "IVAS",
        "locations": ["Redstone Arsenal", "Aberdeen, MD", "Fort Liberty"],
    },
]
...
class GeocodingEngine:
    ...
    def geocode_entity(
        self, entity_id: str, entity_type: str, entity_name: str, location_text: str
    ) -> GeocodedEntity:
    ...
    def get_facilities(
        self, region: str = "", facility_type: str = "", state: str = ""
    ) -> List[GeoPoint]:
