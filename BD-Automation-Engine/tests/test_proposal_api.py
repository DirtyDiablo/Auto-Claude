...
class TestCapabilityEndpoint:
    def test_generate_capability(self, client):
        resp = client.post("/proposals/capability-statement", json={
            "program": "DCGS",
            "agency": "USAF",
            "variant": "two_page",
        })
...
class TestPastPerformanceEndpoint:
    def test_build_past_performance(self, client):
        resp = client.post("/proposals/past-performance", json={
...
class TestComplianceEndpoint:
    def test_from_text(self, client):
        resp = client.post("/proposals/compliance-matrix", json={
            "rfp_title": "DCGS RFP",
    ...
    def test_from_requirements(self, client):
        resp = client.post("/proposals/compliance-matrix", json={
            "rfp_title": "Test RFP",
            "requirements": [
                {"id": "REQ-001", "text": "Shall provide cleared staffing", "type": "staffing"},
            ],
        })
        assert resp.status_code == 200
...
class TestPricingEndpoints:
    def test_labor_categories(self, client):
        resp = client.post("/proposals/pricing/labor-categories", json={
    ...
    def test_rate_card(self, client):
        resp = client.post("/proposals/pricing/rate-card", json={
    ...
    def test_pricing_analysis(self, client):
        resp = client.post("/proposals/pricing/analysis", json={
            "program": "DCGS",
            "categories": [
                {"title": "Intelligence Analyst", "clearance": "TS/SCI"},
            ],
...
class TestFullPackageEndpoint:
    def test_full_package(self, client):
        resp = client.post("/proposals/full-package", json={
            "program": "DCGS",
            "agency": "USAF",
...
class TestTemplatesAndHistory:
    ...
    def test_history(self, client):
        ...
        client.post("/proposals/capability-statement", json={
            "program": "DCGS", "agency": "USAF",
        })
