...
class TestDashboardIntegration:
    ...
    def test_run_integration_exists(self):
        ...
        try:
            from Engine7_BullhornETL.scripts.dashboard_integration import run_integration
    ...
    def test_past_performance_json_structure(self):
        ...
        if data:
            record = data[0]
            expected_keys = [
                'id', 'prime_contractor', 'total_jobs', 'total_placements',
                'avg_bill_rate', 'relationship_strength'
            ]
...
class TestDataFreshnessMetadata:
    ...
    def test_data_freshness_file_exists(self):
        ...
        if not filepath.exists():
            pytest.skip("data_freshness.json not found - run dashboard integration first")
    ...
    def test_data_freshness_lists_all_files(self):
        ...
        expected_files = [
            'past_performance', 'prime_org_chart', 'contact_org_chart',
            'program_org_chart', 'placements', 'correlation_summary_enriched'
        ]
...
class TestCorrelationSummary:
    ...
    def test_correlation_summary_structure(self):
        ...
        expected_sections = [
            'data_sources', 'financial_metrics',
            'contact_metrics', 'program_metrics', 'prime_metrics'
        ]
...
class TestBullhornETLPipeline:
    ...
    def test_bullhorn_database_exists(self):
        ...
        db_path = Path(__file__).parent.parent / 'Engine7_BullhornETL' / 'data' / 'bullhorn_master.db'
...
class TestDashboardDataLoaders:
    ...
    def test_load_bullhorn_data_exists(self):
        ...
        try:
            from Engine7_BullhornETL.scripts.dashboard_integration import load_bullhorn_data
    ...
    def test_load_federal_programs_exists(self):
        ...
        try:
            from Engine7_BullhornETL.scripts.dashboard_integration import load_federal_programs
    ...
    def test_create_past_performance_exists(self):
        ...
        try:
            from Engine7_BullhornETL.scripts.dashboard_integration import create_past_performance_dashboard_data
