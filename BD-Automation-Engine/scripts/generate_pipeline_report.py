...
def load_data():
    ...
    ig_mapped = pd.read_csv(
        BASE_DIR
        / "Engine2_ProgramMapping/data/Insight Global Jobs - Program Mapped (Dec 2025).csv"
    )
    ...
    with open(
        BASE_DIR
        / "Engine1_Scraper/data/dataset_puppeteer-scraper_2026-01-19_13-00-08-552-Apex-Systems.json",
        "r",
        encoding="utf-8",
    ) as f:
    ...
    with open(
        BASE_DIR
        / "Engine1_Scraper/data/dataset_puppeteer-scraper_2026-01-19_13-10-22-621-Insight-Global-Cleared-Jobs-USA.json",
        "r",
        encoding="utf-8",
    ) as f:
        ig_jobs = json.load(f)
    ...
    with open(
        BASE_DIR
        / "Engine1_Scraper/data/dataset_puppeteer-scraper_2026-01-19_13-25-19-708-Apex-Systems2.json",
        "r",
        encoding="utf-8",
    ) as f:
...
def generate_pipeline_data(opportunities, gdit_jobs):
    ...
    for opp in sorted_opps[:60]:  # Top 60 opportunities
        entry = {
            "Client": f"{opp['Prime']} - {opp['Program'][:30]}"
            if opp["Program"]
            else opp["Prime"],
    ...
    meetings = {
            ...
            "last_week": [
                {
                    ...
                    "name": "Robyn Moses",
                    "title": "Deputy PM",
                    "takeaways": "Pending CIS RFP; Waiting on final extension funding #s. BUILD",
                },
                {
                    "num": 2,
                    "customer": "Peraton",
                    "name": "Matt Reda",
                    "title": "Task Order 7/3 Lead",
                    "takeaways": "Can leverage his CIA contacts if we get an introduction. BUILD",
                },
                {
                    "num": 3,
                    "customer": "GDIT JUSTIFIED",
                    "name": "Jonathan Miner",
                    "title": "Pentagon Lead",
                    "takeaways": "Multiple ISSO/ISSM openings. High urgency. BUILD",
                },
            ],
            "this_week": [
                {
        ...
        "Tier II": {  # Active contractors <20k
            "last_week": [
                {
                    "num": 1,
                    "customer": "GDIT INSCOM",
                    "name": "Rick Maldonado",
                    "title": "I2TS4 Manager",
                    "takeaways": "High volume - Ft Meade/Lewis-McChord. BUILD",
                },
                {
                    "num": 2,
                    "customer": "GDIT JUSTIFIED",
                    "name": "Mark Trudel",
                    "title": "Hanscom Lead",
                    "takeaways": "Security clearance bottleneck issue. BUILD",
                },
            ],
            "this_week": [
                {
                    ...
                    "name": "TBD",
                    "title": "Program Contact",
                    "time": "Research and schedule intro",
                },
                {
                    "num": 2,
                    "customer": "GDIT NCIS",
        ...
        "Tier 2.5": {  # Past agreements, no active
            ...
            "this_week": [
                {
                    "num": 1,
                    "customer": "BAE Systems DCGS",
                    "name": "TBD",
                    "title": "Program Manager",
                    "time": "LinkedIn research this week",
                },
                {
                    "num": 2,
                    "customer": "Northrop MDA",
                    "name": "TBD",
                    "title": "Hiring Manager",
                    "time": "LinkedIn research this week",
                },
        ...
        "Tier III": {  # True account breakers
            ...
            "this_week": [
                {
                    "num": 1,
                    "customer": "SAIC AESD-W",
                    "name": "TBD",
                    "title": "Info Systems Lead",
                    "time": "URGENT - Account recently opened",
                },
                {
                    "num": 2,
                    "customer": "Raytheon Space",
                    "name": "TBD",
                    "title": "CO Springs PM",
                    "time": "LinkedIn prospecting",
                },
                {
                    "num": 3,
                    "customer": "Amentum",
                ...
                {
                    "num": 4,
                    "customer": "Booz Allen IC",
                    "name": "TBD",
                    "title": "Intel Programs",
                    "time": "LinkedIn prospecting",
                },
            ],
        },
...
def main():
    ...
    output_path = (
        BASE_DIR
        / f"outputs/BD_Pipeline_Report_{datetime.now().strftime('%Y-%m-%d_%H-%M')}.xlsx"
    )
