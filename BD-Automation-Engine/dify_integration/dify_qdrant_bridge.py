...
class DifyQdrantBridge:
        ...
        try:
            ...
            for item in data.get("results", []):
                ...
                if isinstance(item, dict):
                    content = item.get("text") or item.get("payload", {}).get(
                        "text", ""
                    )
                    ...
                    metadata = {
                        ...
                        or item.get("payload", {}).get("source", ""),
    ...
    async def search_contacts(
        self, query: str, company: str = None, tier: str = None, top_k: int = 10
    ) -> List[DifySearchResult]:
        """
    ...
    async def search_programs(
        self, query: str, agency: str = None, prime: str = None, top_k: int = 10
    ) -> List[DifySearchResult]:
        """
    ...
    async def ask_rag(
        self, question: str, collection: str = None, include_sources: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    async def get_smart_answer(
        self, question: str, use_cache: bool = True
    ) -> Dict[str, Any]:
        """
