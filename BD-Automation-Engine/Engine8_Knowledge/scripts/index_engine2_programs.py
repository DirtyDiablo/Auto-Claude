    ...
    for fname in program_files:
        for dir in [ENGINE2_DIR, ENGINE2_DATA]:
            ...
            if path.exists():
                ...
                total += index_records(
                    qdrant, records, "programs", build_program_text, fname
                )
                break
    ...
    for fname in contractor_files:
        for dir in [ENGINE2_DIR, ENGINE2_DATA]:
            ...
            if path.exists():
                records = load_csv(path)
                total += index_records(
                    qdrant, records, "documents", build_contractor_text, fname
                )
                break
    ...
    for fname in vehicle_files:
        for dir in [ENGINE2_DIR, ENGINE2_DATA]:
            ...
            if path.exists():
                records = load_csv(path)
                total += index_records(
                    qdrant, records, "documents", build_vehicle_text, fname
                )
                break
    ...
    for fname in opp_files:
        for dir in [ENGINE2_DIR, ENGINE2_DATA]:
            ...
            if path.exists():
                records = load_csv(path)
                total += index_records(
                    qdrant, records, "documents", build_opportunity_text, fname
                )
                break
