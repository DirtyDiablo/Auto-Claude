...
GOLDEN_QUERIES = [
    ...
    {
        "query": "Who is Kingsley Ero?",
        "expected": ["Kingsley Ero"],
        "category": "entity",
    },
    {
        "query": "What programs does GDIT run?",
        "expected": ["DCGS", "AF DCGS"],
        "category": "entity",
    },
    {"query": "What company is Leidos?", "expected": ["Leidos"], "category": "entity"},
    {
        "query": "Who works at Northrop Grumman?",
        "expected": ["Northrop Grumman"],
        "category": "entity",
    },
    {"query": "Tell me about SAIC", "expected": ["SAIC"], "category": "entity"},
    {
        "query": "What is the DCGS program?",
        "expected": ["DCGS", "Distributed Common Ground System"],
        "category": "entity",
    },
    {
        "query": "Who manages the JSTARS program?",
        "expected": ["JSTARS"],
        "category": "entity",
    },
    {
        "query": "What is Booz Allen Hamilton?",
        "expected": ["Booz Allen"],
        "category": "entity",
    },
    {
        "query": "Find contacts at Raytheon",
        "expected": ["Raytheon"],
        "category": "entity",
    },
    {
        "query": "What programs are in the Army?",
        "expected": ["Army"],
        "category": "entity",
    },
    # ── Category 2: Relationship queries (10) ──
    {
        "query": "How is David Winkelman connected to DCGS?",
        "expected": ["David Winkelman", "DCGS"],
        "category": "relationship",
    },
    {
        "query": "What companies compete on DCGS?",
        "expected": ["DCGS"],
        "category": "relationship",
    },
    {
        "query": "Find introduction path to the DCGS PM",
        "expected": ["DCGS"],
        "category": "relationship",
    },
    {
        "query": "Who knows someone at Lockheed Martin?",
        "expected": ["Lockheed"],
        "category": "relationship",
    },
    {
        "query": "What is the relationship between Leidos and SAIC?",
        "expected": ["Leidos", "SAIC"],
        "category": "relationship",
    },
    {
        "query": "Which programs connect Fort Meade and San Diego?",
        "expected": ["Fort Meade", "San Diego"],
        "category": "relationship",
    },
    {
        "query": "Who reports to the DCGS program manager?",
        "expected": ["DCGS"],
        "category": "relationship",
    },
    {
        "query": "How are Northrop and Raytheon connected?",
        "expected": ["Northrop", "Raytheon"],
        "category": "relationship",
    },
    {
        "query": "What team works on GBSD?",
        "expected": ["GBSD"],
        "category": "relationship",
    },
    {
        "query": "Find all subcontractors on DCGS",
        "expected": ["DCGS"],
        "category": "relationship",
    },
    # ── Category 3: Semantic queries (10) ──
    {
        "query": "ISR analyst burnout and retention challenges",
        "expected": ["ISR", "analyst"],
        "category": "semantic",
    },
    {
        "query": "Cloud migration strategies for defense programs",
        "expected": ["cloud", "defense"],
        "category": "semantic",
    },
    {
        "query": "Zero trust architecture implementation",
        "expected": ["zero trust"],
        "category": "semantic",
    },
    {
        "query": "AI/ML applications in intelligence analysis",
        "expected": ["AI", "ML", "intelligence"],
        "category": "semantic",
    },
    {
        "query": "Modernization challenges for legacy SIGINT systems",
        "expected": ["SIGINT", "modernization"],
        "category": "semantic",
    },
    {
        "query": "Cybersecurity requirements for classified networks",
        "expected": ["cybersecurity", "classified"],
        "category": "semantic",
    },
    {
        "query": "Agile software development in DoD programs",
        "expected": ["agile", "DoD"],
        "category": "semantic",
    },
    {
        "query": "Past performance on ISR programs",
        "expected": ["ISR", "past performance"],
        "category": "semantic",
    },
    {
        "query": "Digital engineering transformation",
        "expected": ["digital engineering"],
        "category": "semantic",
    },
    {
        "query": "Multi-domain operations concept of operations",
        "expected": ["multi-domain"],
        "category": "semantic",
    },
    # ── Category 4: Keyword queries (10) ──
    {
        "query": "TS/SCI CI Poly network engineer",
        "expected": ["TS/SCI", "network engineer"],
        "category": "keyword",
    },
    {
        "query": "Secret clearance Java developer Fort Meade",
        "expected": ["Java", "Fort Meade"],
        "category": "keyword",
    },
    {
        "query": "SIGINT analyst TS/SCI San Diego",
        "expected": ["SIGINT", "San Diego"],
        "category": "keyword",
    },
    {
        "query": "Program manager PMP certification",
        "expected": ["program manager", "PMP"],
        "category": "keyword",
    },
    {
        "query": "Cybersecurity CISSP Top Secret",
        "expected": ["CISSP", "Top Secret"],
        "category": "keyword",
    },
    {
        "query": "DevSecOps engineer cloud AWS",
        "expected": ["DevSecOps", "AWS"],
        "category": "keyword",
    },
    {
        "query": "Full stack developer React Python clearance",
        "expected": ["React", "Python"],
        "category": "keyword",
    },
    {
        "query": "Systems engineer MBSE DOORS",
        "expected": ["MBSE", "DOORS"],
        "category": "keyword",
    },
    {
        "query": "Data scientist machine learning TS/SCI",
        "expected": ["data scientist", "TS/SCI"],
        "category": "keyword",
    },
    {
        "query": "RF engineer electronic warfare",
        "expected": ["RF", "electronic warfare"],
        "category": "keyword",
    },
    # ── Category 5: Multi-hop queries (10) ──
    {
        "query": "Which company has the most open jobs at DCGS sites?",
        "expected": ["DCGS"],
        "category": "multihop",
    },
    {
        "query": "Who are Tier 1 contacts at companies priming on ISR programs?",
        "expected": ["Tier 1", "ISR"],
        "category": "multihop",
    },
    {
        "query": "What clearance do most DCGS contractor positions require?",
        "expected": ["DCGS", "clearance"],
        "category": "multihop",
    },
    {
        "query": "Which Fort Meade programs have recompetes in 2027?",
        "expected": ["Fort Meade", "2027"],
        "category": "multihop",
    },
    {
        "query": "Find Tier 1 contacts at Leidos working on Army programs",
        "expected": ["Leidos", "Army"],
        "category": "multihop",
    },
    {
        "query": "What programs overlap between Northrop and Raytheon in Colorado?",
        "expected": ["Northrop", "Raytheon", "Colorado"],
        "category": "multihop",
    },
    {
        "query": "Which hiring managers have the most BD interactions?",
        "expected": ["hiring", "BD"],
        "category": "multihop",
    },
    {
        "query": "Companies with jobs in both San Diego and Fort Meade",
        "expected": ["San Diego", "Fort Meade"],
        "category": "multihop",
    },
    {
        "query": "Programs losing incumbent contracts in the next 12 months",
        "expected": ["recompete"],
        "category": "multihop",
    },
    {
        "query": "Contacts who attended meetings about DCGS modernization",
        "expected": ["DCGS", "modernization"],
        "category": "multihop",
    },
]
...
class SearchBenchmarkV2:
    ...
    def compare_modes(
        self, results: Optional[dict[str, BenchmarkResult]] = None
    ) -> list[dict]:
    ...
    def export_report(
        self, results: dict[str, BenchmarkResult], path: Optional[str] = None
    ) -> dict:
